  ...
  <div class="jumbotron">
   <fieldset>
    <legend>A学校：先生/学生登録</legend>
     ...
     <label>管理FLG：
      一般（学生）<input type="radio" name="kanri_flg" value="0"<?php echo($kanri_flg == "0")? "checked":"";?>>　
      管理者（先生）<input type="radio" name="kanri_flg" value="1"<?php echo($kanri_flg == "1")? "checked":"";?>>
    </label>
    <br>
     <label>在学FLG：
      在学<input type="radio" name="life_flg" value="0"<?php echo($kanri_flg == "0")? "checked":"";?>>　
      卒業<input type="radio" name="life_flg" value="1"<?php echo($kanri_flg == "1")? "checked":"";?>>
    </label>
    <br>
